                        ...
                        <div class="col-12">
                            ...
                            <div class="breadcrumb-wrapper">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active"><a href="#">Dosen Pembimbing Magang</a>
                                    </li>
                                </ol>
                            </div>
                        </div>
                                ...
                                <table class="datatables-basic table">
                                    <thead>
                                        <tr>
                                            ...
                                            <th style="texzt-align: center">Mahasiswa Bimbingan</th>
                                    ...
                                    <tbody>
                                        @foreach ($dosens as $dosen)
                                            ...
                                            <tr>
                                                ...
                                                <td style="text-align: center">{{ $mahasiswa_bimbingan }}</td>
                                                <td style="text-align: center"><a href="/magang/pembimbing/{{ $dosen->dosen->kds }}" class="btn btn-primary me-1">Lihat</a></td>
                                            </tr>
                                        @endforeach
                                    </tbody>
                                </table>
