                                ...
                                <div class="col-12">
                                    <div class="card">
                                        <div class="card-header">
                                            <h4 class="card-title">Silahkan Pilih Dosen Untuk User Kaprodi</h4>
                                        </div>
                                        <div class="card-body">
                                            <div class="row">
                                                <form action="/admin/user-kaprodi" method="POST">
                                                    @csrf
                                                    <!-- Basic -->
                                                    <div class="col-md-12 mb-1">
                                                        <label class="form-label" for="select2-basic">Pilih Dosen</label>
                                                        <select class="select2 form-select" id="select2-basic" name="dosen_id" required>
                                                            {{-- <option label=''></option> --}}
