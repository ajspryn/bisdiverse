            ...
            <div class="content-header row">
                <div class="content-header-left col-md-9 col-12 mb-2">
                    <div class="row breadcrumbs-top">
                        <div class="col-12">
                            <h2 class="content-header-title float-start mb-0">Mahasiswa Bimbingan</h2>
                            <div class="breadcrumb-wrapper">
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="/">Magang</a>
                                    </li>
                                    <li class="breadcrumb-item"><a href="#">Mahasiswa Bimbingan</a>
                                    </li>
                                        ...
                                        @foreach ($mahasiswas as $mahasiswa)
                                            <tr>
                                                ...
                                                <td style="text-align: center">
                                                    <a href="/magang/bimbingan/{{ $mahasiswa->id }}" class="btn btn-primary me-1">Lihat</a>
                                            </tr>
                                        @endforeach
                                    </tbody>
                                </table>
